	...
	?>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="menu_name" value="<?php echo $menucek['menu_name'] ?>">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<?php if ($menucek['menu_mother']==1) {?>
            						<input type="checkbox" class="form-check"   value="1" name="menu_mother" checked>
						...
						<div class="col-md-12">
							...
							<button type="submit" style="float: right; margin: 15px;" class="btn btn-info" name="menuupdate">Yadda Saxla</button>
					</div>
				</div>
			</div>

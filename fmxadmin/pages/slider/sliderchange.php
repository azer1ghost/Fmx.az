...
<div id="page-wrapper">
	...
	$slide=$db->prepare("SELECT * from slider where slider_id=:slider_id");
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<p class="help-block">Slaydın aktiv və ya passiv olduğunu təyin edin
								</p>
							</div>
						</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<button type="submit" style="float: right; margin: 15px;" class="btn btn-info" name="sliderchange">Yadda Saxla</button>
					</div>
				</div>
			</div>

...
<div id="page-wrapper">
	...
	$slide=$db->prepare("SELECT * from employee where slider_id=:slider_id");
	...
	?>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<p class="help-block">aktiv və ya passiv olduğunu təyin edin
								</p>
							</div>
						</div>
					...
					<div class="col-md-6">
						<div class="form-group">
								<label>Əməkdaş adı</label>
								<input class="form-control" type="text" value="<?php echo $print['slider_title'] ?>" name="slider_title" >
						</div>
					</div>

					

						<button type="submit" style="float: right; margin: 15px;" class="btn btn-info" name="employeechange">Yadda Saxla</button>
					</div>
				</div>
			</div>

			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<p class="help-block">yerləşmə sırası  sirası 
								</p><br>
							</div>
						</div>
					...
					<div class="col-md-6">
						...
						<button type="submit" style="float: right; margin: 15px;" class="btn btn-info" name="employeeadd">Yadda Saxla</button>
					</div>
				</div>
			</div>
